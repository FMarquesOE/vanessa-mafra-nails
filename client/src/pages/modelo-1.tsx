...
const CONFIG = {
  ...
  galeria: [
    { label: "Unhas em Gel", src: "/public/fotos/trabalho-01.jpg" },
    { label: "Banho de Gel", src: "/public/fotos/trabalho-02.jpg" },
    { label: "Blindagem", src: "/public/fotos/trabalho-03.jpg" },
    { label: "Mão e Pé Tradicional", src: "/public/fotos/trabalho-04.jpg" },
    { label: "SPA dos Pés", src: "/public/fotos/trabalho-05.jpg" },
    { label: "Plástica dos Pés", src: "/public/fotos/trabalho-06.jpg" },
  ],
};
...
<div style={{ display: "flex", alignItems: "center", gap: isMobile ? 6 : 10 }}>
  <div style={{ width: isMobile ? 40 : 60, height: isMobile ? 40 : 60, flexShrink: 0 }}>
    <img
      src="/public/fotos/LogoPrinc.png"
      alt="Logo_Superior"
